...
public class CadastroAlunoActivity extends AppCompatActivity {
    ...
    public void salvar(View view){
        ...
        if(telefone.getText().toString().isEmpty()){
            Toast.makeText(this, "Campo telefone residencial de preenchimento OBRIGATÓRIO!", Toast.LENGTH_SHORT).show();
        ...
        if(isValidPhoneResid(telefone.getText().toString().trim()) == false){
            ...
            Toast.makeText(this, "telefone residencial " + telefone.getText() + " inválido!", Toast.LENGTH_SHORT).show();
